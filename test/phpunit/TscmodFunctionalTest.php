...
/**
 * \file    test/phpunit/TscmodFunctionalTest.php
 * \ingroup tscmod
 ...
 * @package Testtscmod
 */
class TscmodFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/tscmod/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('tscmod/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/tscmod/admin/about.php');
		$this->authenticate();
		return $this->assertContains('tscmod/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('tscmodwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTscmod_TscmodTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTscmod_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
